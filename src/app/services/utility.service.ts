...
export class UtilityService {
    ...
    public errorCodeDefineMessage = [
        ...
        { key: 'ObjectHaveExists', value: 'Bản ghi đã tồn tại' },
        ...
        { key: 'ID_BANKTRANSACTION_ALREADY', value: 'Mã số đã tồn tại' },
        { key: 'THERE_ARE_UNPAID_ORDERS_PLASES_PAY_OFF_THE_ORDERS', value: 'Có đơn hàng chưa tất toán, vui lòng tất toán hết các đơn hàng!' },
        { key: 'COULD_NOT_GET_EXCHANGE_RATE', value: 'Không lấy được tỷ giá ngày mua!' },
        { key: 'ORDER_TRANSPORT_PACKAGES_NOT_FOUND', value: 'Vui lòng thêm gói hàng!' }
